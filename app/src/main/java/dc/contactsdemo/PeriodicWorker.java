        ...
        if (cursor.getCount() > 0) {
            while (cursor.moveToNext()) {
                ...
                if (Integer.parseInt(has_phone) > 0) {
                    ...
                    Cursor pCur;
                    pCur = getApplicationContext().getContentResolver().query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, null, ContactsContract.CommonDataKinds.Phone.CONTACT_ID + " = ?", new String[]{id}, null);
